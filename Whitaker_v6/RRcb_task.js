...
function gen_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of gen_instructionsComponents)
...
function screen_calibrationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of screen_calibrationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function screen_calibration_endRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of screen_calibration_endComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function screen_calibration_end_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of screen_calibration_end_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function candb_instructionsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of candb_instructionsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function loop_spatialLoopBegin(loop_spatialLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_spatial of loop_spatial) {
...
function loop_temporalLoopBegin(loop_temporalLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_temporal of loop_temporal) {
...
function loop_spatial_expLoopBegin(loop_spatial_expLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_spatial_exp of loop_spatial_exp) {
...
function loop_temporal_expLoopBegin(loop_temporal_expLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisLoop_temporal_exp of loop_temporal_exp) {
...
function fixationcrossesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of fixationcrossesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function targetlinesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of targetlinesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function start_xRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of start_xComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function end_xRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of end_xComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function hg_startRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of hg_startComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function hg_midRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of hg_midComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function hg_endRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of hg_endComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function troubleshootingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of troubleshootingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function request_instRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of request_instComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practicetrialendscreenRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practicetrialendscreenComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function catchtrialsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of catchtrialsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
